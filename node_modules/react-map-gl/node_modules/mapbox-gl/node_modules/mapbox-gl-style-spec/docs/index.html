  ...
  <div class='limiter'><div class='col3 contain'>
    <nav class='scroll-styled quiet-scroll small'>
      ...
      <div class='space-bottom1'>
        <a class='block truncate strong' href='#'>Style Reference <span class='quiet'>v8</span></a>
      </div>
...
{% endhighlight %}
  ...
  {% capture prop_doc %}Stylesheet version number. Must be 8.{% endcapture %}
...
{% endhighlight %}
  ...
  {% capture prop_doc %}A base URL for retrieving the sprite image and metadata. The extensions `.png`, `.json` and scale factor `@2x.png` will be automatically appended. This property is required if any layer uses the 'sprite-image' layout property.{% endcapture %}
  <div class='space-bottom1 small pad2x'>{{prop_doc | markdownify}}</div>
...
{% endhighlight %}
  ...
  {% capture prop_doc %}A URL template for loading signed-distance-field glyph sets in PBF format. The URL must include `{fontstack}` and `{range}` tokens. This property is required if any layer uses the 'text-field' layout property.{% endcapture %}
  <div class='space-bottom1 small pad2x'>{{prop_doc | markdownify}}</div>
...
{% endhighlight %}
  ...
  <div>
    ...
    <span class='icon step-ramp inline quiet'></span>
  ...
  <div>
    ...
    <span class='icon smooth-ramp inline quiet'></span>
